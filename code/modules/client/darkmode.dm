...
/client/proc/force_white_theme() //There's no way round it. We're essentially changing the skin by hand. It's painful but it works, and is the way Lummox suggested.
	...
	winset(src, "rpanewindow", "background-color = [COLOR_DARKMODE_DARKBACKGROUND];background-color = none")
	...
	winset(src, "wikiurl", "text-color = [COLOR_DARKMODE_TEXT];text-color = #000000")
	winset(src, "discordurl", "background-color = #494949;background-color = none")
	winset(src, "discordurl", "text-color = [COLOR_DARKMODE_TEXT];text-color = #000000")
	winset(src, "githuburl", "background-color = #3a3a3a;background-color = none")
	winset(src, "githuburl", "text-color = [COLOR_DARKMODE_TEXT];text-color = #000000")
