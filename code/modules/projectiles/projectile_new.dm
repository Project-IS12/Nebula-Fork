...
/obj/item/projectile
	...
	var/accuracy = 0 //Whether or not the bullet will "miss" the target, even if it connects with it.
	var/dispersion = 0 //How far away your bullet will be from where you clicked
	...
	if(muzzle_type && !silenced)
		if(ispath(muzzle_type))
			if(firer)
				...
				if(firer.dir == NORTH)
					thing.pixel_y = 16
					thing.layer = LYING_HUMAN_LAYER//Below the mob.
