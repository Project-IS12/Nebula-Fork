/obj/item/gun/energy/laser
	...
	material = MAT_STEEL
	projectile_type = /obj/item/projectile/energy/laser/midlaser
...
/obj/item/gun/energy/laser/practice
	...
	icon_state = "laserp"
	projectile_type = /obj/item/projectile/energy/laser/practice
	charge_cost = 10 //How much energy is needed to fire.

/obj/item/gun/energy/laser/practice/proc/hacked()
	return projectile_type != /obj/item/projectile/energy/laser/practice
...
/obj/item/gun/energy/lasercannon
	...
	projectile_type = /obj/item/projectile/energy/laser/heavylaser
	charge_cost = 40
	max_shots = 6
	accuracy = 2
	fire_delay = 20
