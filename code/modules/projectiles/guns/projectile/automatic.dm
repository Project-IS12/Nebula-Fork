/obj/item/gun/projectile/automatic
	...
	firemodes = list(
		...
		list(mode_name="4-round bursts", burst=4, fire_delay=null, one_hand_penalty=1, burst_accuracy=list(0,0,-1,-1), dispersion=list(0.0, 0.0, 0.5, 0.6), burst_delay = 2, automatic = 0),
...
/obj/item/gun/projectile/automatic/machine_pistol
	...
	firemodes = list(
		list(mode_name="semi auto",       burst=1, fire_delay=null, one_hand_penalty=0, burst_accuracy=null, dispersion=null, automatic = 0),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, one_hand_penalty=1, burst_accuracy=list(0,-1,-1),       dispersion=list(0.0, 0.6, 1.0), burst_delay = 2, automatic = 0),
		list(mode_name="automatic",      burst=1, fire_delay=0, one_hand_penalty=7, burst_accuracy=null, dispersion=list(0.0, 0.8, 1.5), burst_delay = 0, automatic = 1),
		)
...
/obj/item/gun/projectile/automatic/merc_smg
	...
	//SMG
	firemodes = list(
		list(mode_name="semi auto",       burst=1, fire_delay=null, one_hand_penalty=4, burst_accuracy=null, dispersion=null, automatic = 0),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, one_hand_penalty=5, burst_accuracy=list(0,-1,-1),       dispersion=list(0.0, 0.6, 1.0), burst_delay = 2, automatic = 0),
		list(mode_name="automatic",      burst=1, fire_delay=0, one_hand_penalty=7, burst_accuracy=null, dispersion=list(0.0, 0.8, 1.5), burst_delay = 0, automatic = 1),
		)
...
/obj/item/gun/projectile/automatic/assault_rifle
	...
	firemodes = list(
		list(mode_name="semi auto",       burst=1, fire_delay=null, one_hand_penalty=8, burst_accuracy=null, dispersion=null, automatic = 0),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, one_hand_penalty=9, burst_accuracy=list(0,-1,-1),       dispersion=list(0.0, 0.6, 1.0), burst_delay = 2, automatic = 0),
		list(mode_name="automatic",      burst=1, fire_delay=0, one_hand_penalty=7, burst_accuracy=null, dispersion=list(0.0, 0.8, 1.5), burst_delay = 0, automatic = 1),
		)
...
/obj/item/gun/projectile/automatic/sec_smg
	...
	firemodes = list(
		list(mode_name="semi auto",      burst=1, fire_delay=null, one_hand_penalty=3, burst_accuracy=null, dispersion=null, automatic = 0),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, one_hand_penalty=4, burst_accuracy=list(0,-1,-1), dispersion=list(0.0, 0.6, 1.0), burst_delay = 2, automatic = 0),
		list(mode_name="automatic",      burst=1, fire_delay=0, one_hand_penalty=7, burst_accuracy=null, dispersion=list(0.0, 0.8, 1.5), burst_delay = 0, automatic = 1)
		)
...
/obj/item/gun/projectile/automatic/bullpup_rifle
	...
	firemodes = list(
		list(mode_name="semi auto",      burst=1,    fire_delay=null, use_launcher=null, one_hand_penalty=8,  burst_accuracy=null, dispersion=null, automatic = 0),
		list(mode_name="automatic",      burst=1, fire_delay=0, one_hand_penalty=7, burst_accuracy=null, dispersion=list(0.0, 0.8, 1.5), burst_delay = 0, automatic = 1),
		list(mode_name="fire grenades",  burst=null, fire_delay=null, use_launcher=1,    one_hand_penalty=10, burst_accuracy=null, dispersion=null, automatic = 0)
	)
...
/obj/item/gun/projectile/automatic/l6_saw
	...
	firemodes = list(
		list(mode_name="short bursts",	burst=5, fire_delay=5, one_hand_penalty=8, burst_accuracy = list(0,-1,-1,-2,-2),          dispersion = list(0.6, 1.0, 1.0, 1.0, 1.2), burst_delay = 2, automatic = 0),
		list(mode_name="long bursts",	burst=8, fire_delay=5, one_hand_penalty=12, burst_accuracy = list(0,-1,-1,-2,-2,-2,-3,-3), dispersion = list(1.0, 1.0, 1.0, 1.0, 1.2), burst_delay = 2, automatic = 0),
