/obj/item
	...
	var/drop_sound = 'sound/items/handle/generic_drop.ogg'
...
/obj/item/verb/verb_pickup()
	...
	if(!(usr)) //BS12 EDIT
		return
	if(usr.incapacitated(INCAPACITATION_STUNNED) || usr.incapacitated(INCAPACITATION_KNOCKOUT) || usr.stat || usr.restrained() || !Adjacent(usr))
