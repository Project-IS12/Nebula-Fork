...
/datum/hud/human/FinalizeInstantiation(var/ui_style='icons/mob/screen/white.dmi', var/ui_color = "#ffffff", var/ui_alpha = 255)
	...
	ui_style = 'icons/mob/screen/luna_midnight.dmi'
	...
	using = new /obj/screen() //Left part of the screen now.
	using.dir = NORTH
	using.icon = ui_style
	using.icon_state = "bg"
	...
	using.icon = ui_style
	using.icon_state = "bg"
	using.screen_loc = "WEST-1,NORTH-15"
	using.layer = UNDER_HUD_LAYER
	adding += using
	...
	using.icon = ui_style
	using.icon_state = "bg"
	using.screen_loc = "WEST-1,NORTH-16"
	using.layer = UNDER_HUD_LAYER
	adding += using
